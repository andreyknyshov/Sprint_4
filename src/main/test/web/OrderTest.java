...
public class OrderTest {
    ...
    public OrderTest(String name, String surname, String address, String station, String phone, String date, String comment, OrderPageObject.Color color, OrderPageObject.DaysCount daysCount) {
        this.name = name;
    ...
    public void canOpenOrderPageWithNavButton() {
        ...
        new WebDriverWait(chromeDriver, 10).until(ExpectedConditions.urlToBe("https://qa-scooter.praktikum-services.ru/order"));
    }
